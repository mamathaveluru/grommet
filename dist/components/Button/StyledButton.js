...
var basicStyle = function basicStyle(props) {
  return (0, _styledComponents.css)(
    ...
    props.theme.button.border.radius,
    ...
    props.theme.text.medium.size,
    props.theme.text.medium.height,
  );
};
...
function getHoverIndicatorStyle(hoverIndicator, theme) {
  ...
  return (0, _styledComponents.css)(
    ['', ' color:', ';'],
    (0, _utils.backgroundStyle)(background, theme),
    (0, _utils.normalizeColor)(theme.global.hover.color, theme),
  );
}
