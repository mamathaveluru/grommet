...
var Calendar =
  ...
  (function(_Component) {
    ...
    function Calendar() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'setReference', function(
        reference,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onClickDay', function(
        dateString,
      ) {
        return function() {
          ...
          if (range) {
            var nextState = (0, _utils.updateDateRange)(
              dateString,
              _this.state,
            );
      ...
      _defineProperty(
        ...
        function(previousMonth, nextMonth) {
    ...
    Calendar.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
    ...
    _proto.render = function render() {
      ...
      var previousMonth = (0, _utils.endOfMonth)(
        (0, _utils.subtractMonths)((0, _utils.startOfMonth)(reference), 1),
      );
      var nextMonth = (0, _utils.startOfMonth)(
        ...
        _react['default'].createElement(
          _Keyboard.Keyboard,
          {
            ...
            onLeft: function onLeft() {
              return (
                focused && _this2.setFocus((0, _utils.addDays)(focused, -1))
              );
            },
...
var CalendarWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
