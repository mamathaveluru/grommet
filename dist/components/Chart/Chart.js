...
var Chart = function Chart(_ref6) {
  ...
  if (
    !sizeState.values ||
    (!(0, _utils2.areNormalizedValuesEquals)(values, sizeState.values) &&
      !(0, _utils2.areNormalizedValuesEquals)(sizeState.values, nextValues)) ||
    (!(0, _utils2.areNormalizedBoundsEquals)(bounds, sizeState.bounds) &&
      !(0, _utils2.areNormalizedBoundsEquals)(sizeState.bounds, nextBounds))
  ) {
    setSizeState({
      bounds: nextBounds,
      values: nextValues,
  ...
  var width =
    sizeWidth === 'full'
      ...
      : (0, _utils.parseMetricToNum)(theme.global.size[sizeWidth] || sizeWidth);
  var height =
    sizeHeight === 'full'
  ...
  var strokeWidth = (0, _utils.parseMetricToNum)(
...
var ChartWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
  ChartDoc || Chart,
);
