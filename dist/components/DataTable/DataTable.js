...
var DataTable =
  ...
  (function(_Component) {
    ...
    function DataTable() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onFiltering', function(
        property,
      ) {
        _this.setState({
          filtering: property,
      ...
      _defineProperty(_assertThisInitialized(_this), 'onFilter', function(
        property,
        value,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onSort', function(
        property,
      ) {
        return function() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onToggleGroup', function(
        groupValue,
      ) {
        return function() {
          ...
          nextGroupState[groupValue] = _extends(
            {},
    ...
    DataTable.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
