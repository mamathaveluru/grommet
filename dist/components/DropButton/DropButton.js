...
var DropButton =
  ...
  (function(_Component) {
    ...
    DropButton.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
    ...
    _proto.componentDidUpdate = function componentDidUpdate(
      ...
      if (!show && prevState.show) {
        ...
        (0, _utils.setFocusWithoutScroll)(
          (forwardRef || this.buttonRef).current,
        );
      }
    };
...
var DropButtonWrapper = (0, _recompose.compose)(_hocs.withForwardRef)(
