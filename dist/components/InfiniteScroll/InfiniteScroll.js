...
var InfiniteScroll =
  ...
  (function(_PureComponent) {
    ...
    function InfiniteScroll() {
      ...
      _defineProperty(
        ...
        function() {
          ...
          if (
            pageHeight &&
            _this.belowMarkerRef.current &&
            !_this.scrollParents
          ) {
            _this.scrollParents = (0, _utils.findScrollParents)(
              _this.belowMarkerRef.current,
            );
      ...
      _defineProperty(
        ...
        function() {
          ...
          if (
            _this.firstPageItemRef.current &&
            _this.lastPageItemRef.current &&
            !pageHeight
          ) {
    ...
    InfiniteScroll.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
