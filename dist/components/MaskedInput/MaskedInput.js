...
var MaskedInput =
  ...
  (function(_Component) {
    ...
    function MaskedInput() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onBlur', function(event) {
        ...
        _this.blurTimeout = setTimeout(function() {
          ...
          if (
            showDrop &&
            _this.dropRef.current &&
            document.activeElement !== _this.inputRef.current &&
            !_this.dropRef.current.parentNode.contains(document.activeElement)
          ) {
            _this.setState({
      ...
      _defineProperty(_assertThisInitialized(_this), 'setValue', function(
        nextValue,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onOption', function(
        option,
      ) {
        return function() {
          var mask = _this.props.mask;
    ...
    MaskedInput.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
...
var MaskedInputWrapper = (0, _recompose.compose)(
  (0, _hocs.withFocus)({
    focusWithMouse: true,
  }),
