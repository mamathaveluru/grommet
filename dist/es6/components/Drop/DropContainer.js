...
var DropContainer =
  ...
  (function(_Component) {
    ...
    function DropContainer() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'place', function(
        preserveHeight,
      ) {
        ...
        if (container && target) {
          ...
          if (align.top) {
            ...
            var percentVisibleAreaBelow =
              100 - (targetRect.bottom / windowHeight) * 100; // Check whether it is within 20% from bottom of the window or visible
