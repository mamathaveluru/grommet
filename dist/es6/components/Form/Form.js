  ...
  (function(_Component) {
    ...
    function Form() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'update', function(
        ...
        _this.setState(
          updateReducer(name, data, error, _this.validations),
          function() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'addValidation', function(
        name,
        validate,
      ) {
    ...
    Form.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
